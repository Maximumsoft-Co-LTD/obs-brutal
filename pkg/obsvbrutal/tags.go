...
func NewStructLogger(logger Logger) *StructLogger {
	return &StructLogger{logger: logger}
}

// LogStruct logs struct fields based on tags
func (sl *StructLogger) LogStruct(v interface{}) Logger {
	logger := sl.logger
...
func LogStructFields(logger Logger, v interface{}) Logger {
...
func AutoLogStructFields(logger Logger) func(interface{}) Logger {
	return func(v interface{}) Logger {
