...
func NewAMQPConsumerMiddleware(logger Logger, provider *OTelProvider) *AMQPConsumerMiddleware {
...
func NewAMQPPublisher(channel *amqp.Channel, logger Logger, provider *OTelProvider) *AMQPPublisher {
...
func NewAMQPConsumer(channel *amqp.Channel, logger Logger, provider *OTelProvider) *AMQPConsumer {
	return &AMQPConsumer{
		channel:    channel,
		logger:     logger,
		provider:   provider,
...
func NewAMQPBatchConsumer(channel *amqp.Channel, logger Logger, provider *OTelProvider, batchSize int, batchTimeout time.Duration) *AMQPBatchConsumer {
