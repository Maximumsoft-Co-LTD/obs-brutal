...
func (m *MockLogger) Ctx(ctx context.Context) Logger {
	// Extract context values if needed
	return m
}

// F implements Logger interface
func (m *MockLogger) F(key string, value interface{}) Logger {
	m.mu.Lock()
	defer m.mu.Unlock()
...
func (m *MockLogger) Fs(fields map[string]interface{}) Logger {
	newMock := m
...
// SetFilter implements Logger interface
func (m *MockLogger) SetFilter(filter Filter) {}

// SetSampler implements Logger interface
func (m *MockLogger) SetSampler(sampler Sampler) {}

// SetFormatter implements Logger interface
func (m *MockLogger) SetFormatter(formatter Formatter) {}

// Level implements Logger interface
func (m *MockLogger) Level(level Level) {
	m.mu.Lock()
	defer m.mu.Unlock()
	m.level = level
}
...
func (m *MockLogger) AssertLogged(t *testing.T, level Level, message string) {
	m.mu.RLock()
	defer m.mu.RUnlock()
...
func (m *MockLogger) AssertLoggedF(t *testing.T, level Level, key string, value interface{}) {
	m.mu.RLock()
	defer m.mu.RUnlock()
...
func (m *MockLogger) AssertNotLogged(t *testing.T, level Level, message string) {
	m.mu.RLock()
	defer m.mu.RUnlock()
...
func (m *MockLogger) AssertLogCount(t *testing.T, level Level, expectedCount int) {
	m.mu.RLock()
	defer m.mu.RUnlock()
...
func CaptureLogger(logger Logger) *LogCapture {
	mock := NewMockLogger()
	return &LogCapture{
		original: logger,
		mock:     mock,
...
func (c *LogCapture) Logger() Logger {
	return c.mock
}

// AssertLogged asserts logs were captured
func (c *LogCapture) AssertLogged(t *testing.T, level Level, message string) {
